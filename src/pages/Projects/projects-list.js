              ...
              <div className="">
                <div className="table-responsive">
                  ...
                  <Modal isOpen={modal} toggle={toggle}>
                    ...
                    <ModalBody>
                      <AvForm onValidSubmit={handleValidProjectSubmit}>
                        <Row form>
                          <Col xs={12}>
                            <AvField
                              type="hidden"
                              value={projectList.img || ""}
                              name="img"
                            />

                            <AvField
                              type="hidden"
                              value={projectList.team || ""}
                              name="team"
                            />
                            ...
                            <div className="mb-3">
                              <AvField
                                ...
                                value={projectList.status || "Completed"}
                              >
                            ...
                            <div className="mb-3">
                              <AvField
                                ...
                                value={projectList.color || "success"}
                              >
